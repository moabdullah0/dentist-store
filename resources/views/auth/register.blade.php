...
<main class="main-content  mt-0">
    <div class="page-header align-items-start min-vh-50 pt-5 pb-11 m-3 border-radius-lg" style="background-image: url('https://www.shutterstock.com/image-vector/dental-care-concept-healthcare-stomatology-600w-2121428990.jpg'); background-position: top;">
                ...
                <div class="card z-index-0">
                    ...
                    <div class="card-body">
                        <form role="form" method="POST" action="{{ route('register') }}">
                            ...
                            <div class="mb-3">
                                <input type="password" class="form-control" placeholder="ConfirmPassword" aria-label="Password"  name="password_confirmation"
                                       required autocomplete="new-password" >
                            </div>
                            ...
                            <div class="flex items-center justify-end mt-4">
                                ...
                                <x-primary-button class="ml-4 bg-blue-900 text-black">
                                    {{ __('Register') }}
                                </x-primary-button>
                            </div>
